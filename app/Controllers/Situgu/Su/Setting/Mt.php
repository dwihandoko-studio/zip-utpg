...
class Mt extends BaseController
{
    ...
    public function index()
    {
        ...
        $data['status_mt'] = $this->_db->table('_tb_maintenance')->where('status', 1)->countAllResults();
    ...
    public function disabled()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $this->_db->transBegin();
            try {
                $this->_db->table('_tb_maintenance')->where('status', 1)->update(['status' => 0]);
    ...
    public function active()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $this->_db->transBegin();
            try {
                $this->_db->table('_tb_maintenance')->where('status', 0)->update(['status' => 1]);
