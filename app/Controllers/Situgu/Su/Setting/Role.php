...
use App\Models\Situgu\Su\SettingroleModel;
use Config\Services;
...
class Role extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new SettingroleModel($request);
        ...
        foreach ($lists as $list) {
            ...
            $action = '<div class="btn-group">
                        ...
                        <div class="dropdown-menu" style="">
                            <a class="dropdown-item" href="javascript:actionDetail(\'' . $list->id . '\', \'' . str_replace("'", "", $list->fullname) . '\');"><i class="bx bx-fingerprint font-size-16 align-middle"></i> &nbsp;Access Role</a>
                        </div>
                    </div>';
    ...
    public function index()
    {
        ...
        return view('situgu/su/setting/role/index', $data);
    }
