...
use App\Models\A\KatberitaModel;
use Config\Services;
use App\Libraries\Profilelib;

class Katberita extends BaseController
{
    ...
    public function getAll()
    {
        ...
        $datamodel = new KatberitaModel($request);
    ...
    public function edit()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $current = $this->_db->table('_tb_kategori_berita')
    ...
    public function delete()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $this->_db->table('_tb_kategori_berita')->where('kid', $id)->delete();
    ...
    public function addSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $cekData = $this->_db->table('_tb_kategori_berita')->where('kategori', $name)->get()->getRowObject();
            ...
            try {
                $this->_db->table('_tb_kategori_berita')->insert($data);
                if ($this->_db->affectedRows() > 0) {
    ...
    public function editSave()
    {
        ...
        if (!$this->validate($rules)) {
            ...
            $cekOldData = $this->_db->table('_tb_kategori_berita')->where('kid', $id)->get()->getRowObject();
            ...
            try {
                $this->_db->table('_tb_kategori_berita')->where('kid', $cekOldData->kid)->update($data);
                if ($this->_db->affectedRows() > 0) {
                    $this->_db->transCommit();
