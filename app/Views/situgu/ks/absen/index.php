        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">ABSEN & DOKUMEN</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Kelengkapan Absen</h4>
                            </div>
                            <div class="col-3">
...
<script>
    function actionUpload(title, bulan, tw, id) {
        $.ajax({
            url: "./formupload",
            type: 'POST',
            data: {
    ...
    function actionEditFile(title, bulan, tw, id, old) {
        $.ajax({
            url: "./editformupload",
            type: 'POST',
            data: {
