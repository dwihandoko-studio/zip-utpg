...
<script>
    function actionDisabled(event) {
        Swal.fire({
            ...
            text: "Nonaktifkan Mode Maintenance : SITUGU",
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('situgu/su/setting/mt/disabled') ?>",
                    type: 'POST',
                    data: {
                        id: 'disable',
                    },
    ...
    function actionActived(event) {
        Swal.fire({
            ...
            text: "Aktifkan Mode Maintenance : SITUGU",
            showCancelButton: true,
            icon: 'question',
            confirmButtonColor: '#3085d6',
            cancelButtonColor: '#d33',
            ...
            if (result.value) {
                $.ajax({
                    url: "<?= base_url('situgu/su/setting/mt/active') ?>",
                    type: 'POST',
                    data: {
                        id: 'active',
                    },
    ...
    $(document).ready(function() {
        ...
        let tableDatatables = $('#data-datatables').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('situgu/su/setting/mt/getAll') ?>",
                "type": "POST",
