<?php if (isset($id)) { ?>
    <div class="modal-body">
        <div class="col-lg-12">
            <label class="col-form-label">Keterangan Penghapusan:</label>
    ...
    <div class="modal-footer">
        ...
        <button type="button" onclick="simpanTolak(this)" class="btn btn-primary waves-effect waves-light">Hapus Data PTK</button>
    </div>
    <script>
        function simpanTolak(e) {
            ...
            if (keterangan === "" || keterangan === undefined) {
                Swal.fire(
                    'PERINGATAN!!!',
                    "Keterangan penghapusan tidak boleh kosong.",
                    'warning'
                );
                return;
            }
