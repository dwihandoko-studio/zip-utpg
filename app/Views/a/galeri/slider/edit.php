    ...
    <form id="formEditModalData" action="./editSave" method="post" enctype="multipart/form-data">
        ...
        <div class="modal-body">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <label for="_sub_judul" class="col-form-label">Sub Title:</label>
                    <input type="text" class="form-control sub_judul" value="<?= $data->sub_judul ?>" id="_sub_judul" name="_sub_judul" placeholder="Sub title..." onfocusin="inputFocus(this);">
                            ...
                            <div class="form-group">
                                <div class="preview-image-upload">
                                    <?php if ($data->image !== null) { ?>
                                        <img class="imagePreviewUpload" src="<?= base_url('uploads/slider') . '/' . $data->image ?>" id="imagePreviewUpload" />
                                    <?php } else { ?>
