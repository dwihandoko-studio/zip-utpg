                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <?php if (listHakAksesCustomAllowNew('data', 'pegawai', 'add')) { ?>
...
<script>
    function actionResetAkun(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('data', 'pegawai', 'resetAkun')) { ?>
            Swal.fire({
                title: 'Apakah anda yakin ingin mereset akun pegawai ini?',
                text: "Reset Akun Pegawai : " + title,
    ...
    function actionCreateAkun(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('data', 'pegawai', 'createAkun')) { ?>
            Swal.fire({
                title: 'Apakah anda yakin ingin membuatkan akun pegawai ini?',
                text: "Buat Akun Pegawai : " + title,
                showCancelButton: true,
                icon: 'question',
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
    ...
    function actionHapus(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('data', 'pegawai', 'delete')) { ?>
            Swal.fire({
                title: 'Apakah anda yakin ingin menghapus data ini?',
                text: "Hapus pegawai : " + title,
                showCancelButton: true,
                icon: 'question',
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
            ...
            $.ajax({
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT PEGAWAI ' + title);
            ...
            $.ajax({
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('DETAIL PEGAWAI ' + title);
                        $('.contentBodyModal').html(resul.data);
                        $('.content-detailModal').modal({
                            backdrop: 'static',
                            keyboard: false,
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('TAMBAH PEGAWAI');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
