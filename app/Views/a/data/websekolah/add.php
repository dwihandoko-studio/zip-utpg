    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <input type="text" class="form-control nama" id="_nama" name="_nama" placeholder="Nama Sekolah..." onfocusin="inputFocus(this);">
                <div class="help-block _nama"></div>
            </div>
            <div class="col-lg-12">
                <label for="_url" class="col-form-label">URL Website Sekolah:</label>
                <input type="text" class="form-control url" id="_url" name="_url" placeholder="Example: https://sekolah.sch.id" onfocusin="inputFocus(this);">
            ...
            <div class="col-lg-12 mt-4">
                <div class="row mt-4">
                    <div class="col-lg-6">
                        <div class="mt-3">
                            <label for="_file" class="form-label">Logo Sekolah / Foto Sekolah: </label>
