        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">WEB SEKOLAH</h4>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <?php if (listHakAksesCustomAllowNew('data', 'websekolah', 'add')) { ?>
...
<script>
    function actionHapus(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('data', 'websekolah', 'delete')) { ?>
            Swal.fire({
                title: 'Apakah anda yakin ingin menghapus data ini?',
                text: "Hapus Web Sekolah : " + title,
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?= base_url('a/data/websekolah/delete') ?>",
                        type: 'POST',
                        data: {
                            id: event,
                        },
    ...
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('data', 'websekolah', 'edit')) { ?>
            $.ajax({
                url: "<?= base_url('a/data/websekolah/edit') ?>",
                type: 'POST',
                data: {
                    id: event,
                },
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT WEB SEKOLAH ' + title);
    ...
    function actionAdd(event) {
        $.ajax({
            url: "<?= base_url('a/data/websekolah/add') ?>",
            type: 'GET',
            dataType: 'JSON',
            beforeSend: function() {
                $('div.main-content').block({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('TAMBAH WEBSEKOLAH');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
    ...
    $(document).ready(function() {
        ...
        let tableDatatables = $('#data-datatables').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('a/data/websekolah/getAll') ?>",
                "type": "POST",
