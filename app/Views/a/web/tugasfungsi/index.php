        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">TUGAS & FUNGSI INSTANSI</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Tugas & Fungsi</h4>
                                <p class="card-title-desc">Tugas & fungsi instansi.</p>
                            </div>
                            <?php if (listHakAksesCustomAllowNew('web', 'tugasfungsi', 'edit')) { ?>
                                <div class="col-6 text-end">
                                    <a href="<?= base_url('a/web/tugasfungsi/edit') ?>" class="btn btn-primary btn-rounded waves-effect waves-light" style="min-width: 6rem;"><i class="bx bx-edit font-size-16 align-middle me-2"></i> Edit </a>
                                </div>
                            <?php } ?>
                        </div>
                        ...
                        <div style="background-color: #fff; padding: 1rem;">
                            <?= isset($data) ? $data->isi : '<div class="text-center">Belum ada tugas & fungsi.</div>' ?>
                        </div>
...
<script>
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('web', 'tugasfungsi', 'edit')) { ?>
            $.ajax({
                url: "<?= base_url('a/web/tugasfungsi/edit') ?>",
                type: 'POST',
                data: {
                    id: event,
                    title: title,
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT TUGAS & FUNGSI INSTANSI');
