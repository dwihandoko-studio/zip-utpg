        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">MAKLUMAT INSTANSI</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <p class="card-title-desc">Maklumat instansi.</p>
                            </div>
                        ...
                        <div style="background-color: #fff; padding: 1rem;">
                            <?= isset($data) ? $data->isi : '<div class="text-center">Belum ada maklumat.</div>' ?>
                        </div>
            ...
            $.ajax({
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT MAKLUMAT INSTANSI');
