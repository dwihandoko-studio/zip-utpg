        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">SAMBUTAN KEPALA INSTANSI</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <p class="card-title-desc">Sambutan Kepala Instansi.</p>
                            </div>
                            <?php if (listHakAksesCustomAllowNew('web', 'sambutan', 'edit')) { ?>
                                <div class="col-6 text-end">
                                    <a href="<?= base_url('a/web/sambutan/edit') ?>" class="btn btn-primary btn-rounded waves-effect waves-light" style="min-width: 6rem;"><i class="bx bx-edit font-size-16 align-middle me-2"></i> Edit </a>
                                </div>
                            <?php } ?>
                        </div>
...
<script>
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('web', 'sambutan', 'edit')) { ?>
            $.ajax({
                url: "<?= base_url('a/web/sambutan/edit') ?>",
                type: 'POST',
                data: {
                    id: event,
                    title: title,
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT SAMBUTAN KEPALA INSTANSI');
