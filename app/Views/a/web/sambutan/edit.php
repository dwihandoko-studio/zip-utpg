        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">UBAH SAMBUTAN KEPALA INSTANSI</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <p class="card-title-desc">Ubah sambutan kepala instansi.</p>
...
<script>
    ...
    $("form").on("submit", function(e) {
        ...
        if (isi.length < 5) {
            Swal.fire(
                "Peringatan!",
                "Isi dari konten sambutan minimal 5 kata.",
                "warning"
            );
            return true;
        }
