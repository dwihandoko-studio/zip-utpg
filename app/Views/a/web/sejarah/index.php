        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">PROFIL SEJARAH INSTANSI</h4>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                ...
                                <p class="card-title-desc">Sejarah instansi.</p>
                            </div>
                            <?php if (listHakAksesCustomAllowNew('web', 'sejarah', 'edit')) { ?>
                                <div class="col-6 text-end">
                                    <a href="<?= base_url('a/web/sejarah/edit') ?>" class="btn btn-primary btn-rounded waves-effect waves-light" style="min-width: 6rem;"><i class="bx bx-edit font-size-16 align-middle me-2"></i> Edit </a>
                                </div>
                            <?php } ?>
                        </div>
                        ...
                        <div style="background-color: #fff; padding: 1rem;">
                            <?= isset($data) ? $data->isi : '<div class="text-center">Belum ada sejarah.</div>' ?>
                        </div>
...
<script>
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('web', 'sejarah', 'edit')) { ?>
            $.ajax({
                url: "<?= base_url('a/web/sejarah/edit') ?>",
                type: 'POST',
                data: {
                    id: event,
                    title: title,
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT SEJARAH INSTANSI');
