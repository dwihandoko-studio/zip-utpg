    ...
    <div class="modal-body">
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <input type="text" class="form-control deskripsi" id="_deskripsi" name="_deskripsi" placeholder="Deskripsi..." onfocusin="inputFocus(this);">
                <div class="help-block _deskripsi"></div>
            </div>
            <div class="col-lg-10">
                <label for="_url" class="col-form-label">Url:</label>
                <input type="text" class="form-control url" id="_url" name="_url" placeholder="https://xxx.com..." onfocusin="inputFocus(this);">
