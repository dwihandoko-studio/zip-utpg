        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">APP PORTAL LAYANAN</h4>
                </div>
            </div>
        </div>
        <!-- end page title -->
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data App Portal Layanan</h4>
                            </div>
                            <?php if (listHakAksesCustomAllowNew('setting', 'portallayanan', 'add')) { ?>
...
<script>
    function actionHapus(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('setting', 'portallayanan', 'delete')) { ?>
            Swal.fire({
                title: 'Apakah anda yakin ingin menghapus data ini?',
                text: "Hapus App Slider : " + title,
    ...
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('setting', 'portallayanan', 'edit')) { ?>
            $.ajax({
                url: "./edit",
                type: 'POST',
                data: {
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT APP PORTAL LAYANAN ' + title);
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('TAMBAH APP PORTAL LAYANAN');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
