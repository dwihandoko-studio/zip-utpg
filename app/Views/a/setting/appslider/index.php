        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">APP SLIDER</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data App Slider</h4>
                            </div>
                            <?php if (listHakAksesCustomAllowNew('setting', 'appslider', 'add')) { ?>
...
<script>
    function actionHapus(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('setting', 'appslider', 'delete')) { ?>
            Swal.fire({
    ...
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('setting', 'appslider', 'edit')) { ?>
            $.ajax({
                url: "./edit",
                type: 'POST',
                data: {
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT APP SLIDER ' + title);
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('TAMBAH APP SLIDER');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
