    ...
    <div class="modal-body">
        <div class="row">
            <div class="col-lg-10">
                ...
                <input type="text" class="form-control judul" id="_judul" name="_judul" placeholder="Nama menu publik..." onfocusin="inputFocus(this);">
                <div class="help-block _judul"></div>
            </div>
            <div class="col-lg-6">
                <label for="_urut" class="col-form-label">Urutan Tampil Menu:</label>
                <input type="number" class="form-control urut" id="_urut" name="_urut" placeholder="Urutan tampil menu..." onfocusin="inputFocus(this);">
                ...
                <div class="row">
                    <div class="col-lg-2">
                        ...
                        <div class="form-check mb-3">
                            <input class="form-check-input" onchange="changeExternalLink()" type="radio" name="external_link" id="external_link_1" value="1" checked>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="form-check">
                            <input class="form-check-input" onchange="changeExternalLink()" value="0" type="radio" name="external_link" id="external_link_2">
            ...
            <div class="col-lg-12 url-content-app" style="display: block;">
                <label for="_url_external_link" class="col-form-label">URL External Link:</label>
                <input type="text" class="form-control url_external_link" id="_url_external_link" name="_url_external_link" placeholder="Url eksternal link..." onfocusin="inputFocus(this);">
                <div class="help-block _url_external_link"></div>
            </div>
            <div class="col-lg-12 isi-content-app" style="display: none;">
