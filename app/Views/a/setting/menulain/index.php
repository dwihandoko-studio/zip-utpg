        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">MENU LAIN PUBLIK</h4>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col-6">
                                <h4 class="card-title">Data Menu Lain Publik</h4>
                            </div>
                            <?php if (listHakAksesCustomAllowNew('setting', 'menulain', 'add')) { ?>
...
<script>
    ...
    function actionHapus(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('setting', 'menulain', 'delete')) { ?>
            Swal.fire({
                title: 'Apakah anda yakin ingin menghapus data ini?',
                text: "Hapus Menu Lain Publik : " + title,
    ...
    function actionDetail(event, title) {
        <?php if (listHakAksesCustomAllowNew('setting', 'menulain', 'detail')) { ?>
            $.ajax({
                url: "./detail",
                type: 'POST',
                data: {
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('DETAIL MENU LAIN PUBLIK ' + title);
    ...
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('setting', 'menulain', 'edit')) { ?>
            $.ajax({
                url: "./edit",
                type: 'POST',
                data: {
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT MENU LAIN PUBLIK ' + title);
                        $('.contentBodyModal').html(resul.data);
                        $('.content-detailModal').modal({
                            backdrop: 'static',
                            keyboard: false,
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('TAMBAH MENU LAIN PUBLIK');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
