<?php if (isset($data)) { ?>
    <form id="formEditModalData" action="./editSave" method="post" enctype="multipart/form-data">
        <input type="hidden" id="_id" name="_id" value="<?= $data->rid ?>">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="position-relative" id="datepicker5">
                        <input type="text" class="form-control" value="<?= $data->tahun ?>" name="_tahun" data-provide="datepicker" data-date-container='#datepicker5' data-date-format="yyyy" data-date-min-view-mode="2">
                    </div>
                </div>
                <div class="col-lg-6">
                    <label for="_nomor" class="col-form-label">Nomor Regulasi:</label>
                    <input type="text" class="form-control nomor" value="<?= $data->nomor ?>" id="_nomor" name="_nomor" placeholder="Nomor regulasi..." onfocusin="inputFocus(this);">
                </div>
                <div class="col-lg-10">
                    <label for="_judul" class="col-form-label">Judul Regulasi:</label>
                    <input type="text" class="form-control judul" value="<?= $data->judul ?>" id="_judul" name="_judul" placeholder="Judul regulasi..." onfocusin="inputFocus(this);">
                ...
                <div class="col-lg-12 mt-4">
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            <div class="mt-3">
                                <label for="_file" class="form-label">Lampiran Regulasi: </label>
                                <input class="form-control" type="file" id="_file" name="_file" onFocus="inputFocus(this);" accept="image/*,application/pdf" onchange="loadFilePdf()">
                                ...
                                <div class="mt-4">
                                    <div class="preview-image-upload mt-4">
                                        <?php if ($data->lampiran !== null) { ?>
                                            <a target="_blank" href="<?= base_url() . '/uploads/regulasi/' . $data->lampiran ?>" class="badge badge-pill badge-soft-success">Lampiran pengumuman</a>
                                        <?php } ?>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        $("#formEditModalData").on("submit", function(e) {
            ...
            if (nomor === "") {
                ...
                $('._nomor').html('<ul role="alert" style="color: #dc3545; list-style-type:none; padding-inline-start: 10px;"><li style="color: #dc3545;">Tahun tidak boleh kosong.</li></ul>');
                return false;
            }
            ...
            if (old_lampiran === "") {
                if (fileName === "") {
                    Swal.fire(
                        "Peringatan!",
                        "Lampiran regulasi belum dipilih.",
                        "warning"
                    );
                    return true;
                }
