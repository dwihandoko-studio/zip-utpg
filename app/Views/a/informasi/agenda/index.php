                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <?php if (listHakAksesCustomAllowNew('informasi', 'agenda', 'add')) { ?>
...
<script>
    ...
    function actionHapus(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('informasi', 'agenda', 'delete')) { ?>
            Swal.fire({
                title: 'Apakah anda yakin ingin menghapus data ini?',
                text: "Hapus agenda : " + title,
    ...
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('informasi', 'agenda', 'edit')) { ?>
            $.ajax({
                url: "./edit",
                type: 'POST',
                data: {
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT AGENDA ' + title);
    ...
    function actionDetail(event, title) {
        <?php if (listHakAksesCustomAllowNew('informasi', 'agenda', 'detail')) { ?>
            $.ajax({
                url: "./detail",
                type: 'POST',
                data: {
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('DETAIL AGENDA ' + title);
                        $('.contentBodyModal').html(resul.data);
                        $('.content-detailModal').modal({
                            backdrop: 'static',
                            keyboard: false,
        ...
        $.ajax({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('TAMBAH AGENDA');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
