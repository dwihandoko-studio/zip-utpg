<?php if (isset($data)) { ?>
    <form id="formEditModalData" action="./editSave" method="post">
        ...
        <div class="modal-body" style="padding-top: 0px; padding-bottom: 0px;">
            <div class="mb-3">
                <label for="_name" class="form-label">Nama Kategori Regulasi</label>
                <input type="text" class="form-control name" value="<?= $data->kategori ?>" id="_name" name="_name" placeholder="Nama kategori regulasi..." onfocusin="inputFocus(this);">
