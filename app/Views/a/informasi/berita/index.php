        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0 font-size-18">BERITA</h4>
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            ...
                            <?php if (listHakAksesCustomAllowNew('informasi', 'berita', 'add')) { ?>
...
<script>
    ...
    function actionHapus(event, title = "") {
        <?php if (listHakAksesCustomAllowNew('informasi', 'berita', 'delete')) { ?>
            Swal.fire({
                title: 'Apakah anda yakin ingin menghapus data ini?',
                text: "Hapus berita : " + title,
                ...
                if (result.value) {
                    $.ajax({
                        url: "<?= base_url('a/informasi/berita/delete') ?>",
                        type: 'POST',
                        data: {
                            id: event,
                        },
    ...
    function actionEdit(event, title) {
        <?php if (listHakAksesCustomAllowNew('informasi', 'berita', 'edit')) { ?>
            $.ajax({
                url: "<?= base_url('a/informasi/berita/edit') ?>",
                type: 'POST',
                data: {
                    id: event,
                },
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('EDIT BERITA ' + title);
    ...
    function actionDetail(event, title) {
        <?php if (listHakAksesCustomAllowNew('informasi', 'berita', 'detail')) { ?>
            $.ajax({
                url: "<?= base_url('a/informasi/berita/detail') ?>",
                type: 'POST',
                data: {
                    id: event,
                },
                ...
                success: function(resul) {
                    ...
                    if (resul.status !== 200) {
                        ...
                        $('#content-detailModalLabel').html('DETAIL BERITA ' + title);
                        $('.contentBodyModal').html(resul.data);
                        $('.content-detailModal').modal({
                            backdrop: 'static',
                            keyboard: false,
    ...
    function actionAdd(event) {
        $.ajax({
            url: "<?= base_url('a/informasi/berita/add') ?>",
            type: 'GET',
            dataType: 'JSON',
            beforeSend: function() {
                $('div.main-content').block({
            ...
            success: function(resul) {
                ...
                if (resul.status !== 200) {
                    ...
                    $('#content-detailModalLabel').html('TAMBAH BERITA');
                    $('.contentBodyModal').html(resul.data);
                    $('.content-detailModal').modal({
                        backdrop: 'static',
                        keyboard: false,
    ...
    $(document).ready(function() {
        ...
        let tableDatatables = $('#data-datatables').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= base_url('a/informasi/berita/getAll') ?>",
                "type": "POST",
